/**
  MapBiomas Atlantic Forest - LULC Preview Thumbnail
*/
...
// southern Minas Gerais - coffee, pasture and forest remnants
var region = ee.Geometry.Point([-46.5, -21.5]).buffer(20000).bounds();
